    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                <p class="text-muted mb-1">My Submissions</p>
    ...
    <div class="row mt-4 g-4">
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                ...
                <a href="/my-submissions" class="btn btn-outline-secondary rounded-pill w-100">
                    View My Submissions
                </a>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                <h5 class="fw-bold mb-3 text-dark">📌 Profile</h5>

                <p><strong>Name:</strong> {{ auth()->user()->name }}</p>
                <p><strong>Email:</strong> {{ auth()->user()->email }}</p>

                <a href="/profile" class="btn btn-warning rounded-pill w-100 text-dark">
                    Edit Profile
                </a>
            </div>
        </div>
